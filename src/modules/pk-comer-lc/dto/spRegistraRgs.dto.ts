...
export class SpRegistraRgsDto {
    ...
    //-----------------------------------------------------------------------------------------------------------------
    @IsString({ message: Message.STRING('$property') })
    @MaxLength(5, { message: Message.MAXLENGTH('$property', '$constraint1') })
    ...
    //-----------------------------------------------------------------------------------------------------------------
    @IsString({ message: Message.STRING('$property') })
    @MaxLength(15, { message: Message.MAXLENGTH('$property', '$constraint1') })
    @ApiProperty({ example: 'INDICADOR DE USUARIO QUE GENERA' })
    P_USER_GENERA: string
    //-----------------------------------------------------------------------------------------------------------------
    @IsString({ message: Message.STRING('$property') })
    @MaxLength(50, { message: Message.MAXLENGTH('$property', '$constraint1') })
    @ApiProperty({ example: 'INDICADOR DEL BANCO QUE EXPIDE CHEQUE' })
    P_BANCO_CHEQUE: string
    //-----------------------------------------------------------------------------------------------------------------
    @IsNumber({}, { message: Message.NUMBER('$property') })
    @Max(999999999999999999999999999999999999, { message: Message.MAX('$property', '$constraint1') })
